...
# load data ---- 
# 
source("COVerAge_plotting_funcs.R")
...
# a wrapped function to save a group of countries  
save_country_plot_in_one(cnames = all_countries[3:8])
...
data_total1 <- rbindlist(lapply(all_countries, get.dt.by.measure, 
