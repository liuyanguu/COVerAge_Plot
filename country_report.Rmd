...
dtJHU_country <- get.JHU.ts(cname = c(cname0))
p1_JHU_P <- plot_country_JHU(dtJHU =dtJHU_country, cname =  cname0)
...
dtt <- dt5_summary[Country == cname0]
...
p2_P <- make_country_plot(cname0, dt1 = dt5)
